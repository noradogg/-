% is_iso = isomorph(name1,name2)
function is_iso = isomorph(name1, name2)
global path;
global tct_name;
global prm_file; 
global rst_file;
...
%--------------------------------------------------------------------------
% generate the prm file for isomorph
...
fprintf(fid, ' = Isomorph(%s,%s)', name1, name2);
fprintf(fid, '\n\n');
fclose(fid);
